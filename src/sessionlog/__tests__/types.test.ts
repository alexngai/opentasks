...
describe('Entire Types', () => {
  ...
  describe('Token Usage', () => {
    ...
    it('should add token usage', () => {
      const a = { inputTokens: 100, outputTokens: 50, cacheCreationTokens: 10, cacheReadTokens: 5, apiCallCount: 2 };
      const b = { inputTokens: 200, outputTokens: 100, cacheCreationTokens: 20, cacheReadTokens: 10, apiCallCount: 3 };
    ...
    it('should handle subagent tokens in addition', () => {
      const a = {
        inputTokens: 100, outputTokens: 50, cacheCreationTokens: 0, cacheReadTokens: 0, apiCallCount: 1,
        subagentTokens: { inputTokens: 50, outputTokens: 25, cacheCreationTokens: 0, cacheReadTokens: 0, apiCallCount: 1 },
      };
      const b = {
        inputTokens: 100, outputTokens: 50, cacheCreationTokens: 0, cacheReadTokens: 0, apiCallCount: 1,
      };
