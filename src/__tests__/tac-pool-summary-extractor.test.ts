  ...
  it('loads run directories and projects optimization metrics into cell rows', async () => {
    ...
    expect(buildCellRows(summaries)).toEqual([
      expect.objectContaining({
        ...
        teamProtocolHelperAssignment: 1,
        teamProtocolHelperEvidenceMessage: 1,
        teamProtocolHelperEvidenceRecord: 1,
        teamProtocolHelperVerificationRequest: 1,
        teamProtocolHelperMutationGate: 1,
        teamProtocolHelperMutationGatePassed: 1,
        teamProtocolMutationBypass: 0,
        teamInboxEvidenceBeforeMutation: 1,
        teamOpenTasksEvidenceAfterInbox: 1,
        teamOpenTasksVerificationAfterVerifier: 1,
        teamProtocolPassed: 1,
    ...
    expect(buildAggregateRows(summaries)).toEqual([
      expect.objectContaining({
        ...
        teamProtocolHelperAssignmentMean: 1,
        teamProtocolHelperEvidenceMessageMean: 1,
        teamProtocolHelperMutationGateMean: 1,
      }),
    ]);
  });
