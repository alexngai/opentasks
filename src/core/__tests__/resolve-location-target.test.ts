...
describe('resolveLocationTarget', () => {
  ...
  describe('bare hash resolution', () => {
    ...
    it('throws for unknown hash with empty connections', () => {
      expect(() => resolveLocationTarget('k7m2x9p4', [], currentLocation, currentPath)).toThrow(
        'Unknown location hash: k7m2x9p4',
      );
    });
  });
  ...
  describe('return type structure', () => {
    ...
    it('never includes nodeId', () => {
      ...
      const result2 = resolveLocationTarget(
        'opentasks://k7m2x9p4/i-node',
        connections,
        currentLocation,
        currentPath,
      );
